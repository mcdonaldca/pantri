class MainController < ApplicationController
  ...
  def pantry
    ...
    veg_uri = URI('https://pmpwfgqrzq.localtunnel.me/api/robots/pantribot/commands/writeMessage')
    ...
    fruits_uri = URI('https://otffgpkadq.localtunnel.me/api/robots/pantribot/commands/writeMessage')
