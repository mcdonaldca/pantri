class MainController < ApplicationController
  ...
  def pantry
    ...
    veg_uri = URI('https://uwihjphemd.localtunnel.me/api/robots/pantribot/commands/writeMessage')
    ...
    fruits_uri = URI('https://qypfvajghq.localtunnel.me/api/robots/pantribot/commands/writeMessage')
