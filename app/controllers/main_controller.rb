class MainController < ApplicationController
  ...
  def pantry
    ...
    veg_uri = URI('https://qqhplswqmr.localtunnel.me/api/robots/pantribot/commands/writeMessage')
    ...
    fruits_uri = URI('https://lkeswzztsh.localtunnel.me/api/robots/pantribot/commands/writeMessage')
